...
time {
    ...
    if [ -d $DEST ]; then
        ...
        rsync -Pruv $DEST/Documents $SOURCE/
        rsync -Pruv $DEST/Downloads $SOURCE/
        rsync -Pruv $DEST/Music $SOURCE/
        rsync -Pruv $DEST/Pictures $SOURCE/
        rsync -Pruv $DEST/Videos $SOURCE/
